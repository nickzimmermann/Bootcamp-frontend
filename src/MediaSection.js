// import React from 'react'; // not necessary because it's already included in index.js
        ...
        <div className="container py-5">
            {
                props.content.map(
                    function(element, index) {
                        ...
                        let rowOrder = "";
                        // % is the modulo operator. This operator returns 0 if the number is divisible by 2.
                        if(index % 2 === 0) {
                            rowOrder = "";
                        } else {
