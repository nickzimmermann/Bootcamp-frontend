...
const RegistrationForm = () => {
    ...
    // states: (1) initial, (2) loading, (3) validationFailed, (4) successful, (5) unsuccesfull
    ...
    const register = () => {
        ...
        if (emailField.value.length === 0) {
            errors.push("Please enter valid email-adress");
        }
        ...
        // 1.2  If there are no errors, set the state to 'loading'
            ...
            // 2.1  If the submission is successful, set state to 'successfull
            .then(
                (backendResponse) => {
            ...
            // 2.2  If the submission is unsuccessful, set state to 'unsuccessful'
            .catch(
                (err) => {
                    console.log(err);
                    setState("unsuccessful");
    ...
    return (
        <div className="container" style={{"marginTop": "5em", "max-width": "40em"}}>
            ...
            <input ref={(element)=>{ phoneNumberField = element }} className="field form-control" name="phone" type="text" />
